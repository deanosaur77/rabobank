...
public class AccountRequest {
    ...
    public String toString() {
        ...
        sb.append(AccountRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AccountRequest) == false) {
            return false;
        }
        AccountRequest rhs = ((AccountRequest) other);
